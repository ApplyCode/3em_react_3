...
import { getClienti } from 'api/anagrafica';
import {
    DefaultColumnFilter,
    renderFilterTypes,
...
function ReactTable({ columns, top }) {
    ...
    const fetchData = useCallback(async ({ pageIndex, pageSize, filters }) => {
        ...
        return await getClienti(pageIndex, pageSize, filters)
    }, [])
...
const FilteringTable = () => {
    ...
    const handleAddCliente = () => {
        dispatch(activeItem({ openItem: ['clienti-create'] }));
        navigate('/anagrafica/clienti-finali/create');
    };
