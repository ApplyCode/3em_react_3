...
const Committenti = Loadable(lazy(() => import('pages/anagrafica/committenti/committenti')));
const CommittentiCreate = Loadable(lazy(() => import('pages/anagrafica/committenti/committenti-create')));

const ClientiFinali = Loadable(lazy(() => import('pages/anagrafica/clienti/clienti')));
const ClientiFinaliCreate = Loadable(lazy(() => import('pages/anagrafica/clienti/clienti-create')));

const Dipendenti = Loadable(lazy(() => import('pages/anagrafica/dipendenti/dipendenti')));
const Contratti = Loadable(lazy(() => import('pages/anagrafica/contratti/contratti')));
const Ordini = Loadable(lazy(() => import('pages/ordini/ordini')));
const OrdiniCreate = Loadable(lazy(() => import('pages/ordini/ordini-create')));
const Descrizioni_Attivita = Loadable(lazy(() => import('pages/centro-costi/descrizioni-attivita')));
const Engineering_Site = Loadable(lazy(() => import('pages/engineering/site')));
const Timesheet_List = Loadable(lazy(() => import('pages/timesheet/timesheet-list')));
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: 'committenti/create',
              element: <CommittentiCreate />,
            },
            {
              path: 'clienti-finali',
              element: <ClientiFinali />
            },
            {
              path: 'clienti-finali/create',
              element: <ClientiFinaliCreate />
            },
            {
              path: 'dipendenti',
              element: <Dipendenti />
        ...
        {
          path: 'ordini-create',
          element: <OrdiniCreate />
        },
        {
          path: 'centro-costi',
          children: [
            {
              path: 'descrizioni-attivita',
              element: <Descrizioni_Attivita />
            }
          ]
        },
        {
          ...
          children: [
            {
              path: 'site',
              element: <Engineering_Site />
            }
          ]
        },
        {
          path: 'timesheet-list',
          element: <Timesheet_List />,
          children: [
          ]
        },
        {
